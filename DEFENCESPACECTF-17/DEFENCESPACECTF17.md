...
İlk olarak kullandığım sanallaştırma ortamı olan Oracle VirtualBox'ta hem Kali Linux'umu hem de hedef makinem olan DEFENCESPACE'i ayaklandırıyorum ve her zamanki gibi Kali makinemin ip adresini bularak başlıyorum.
    ...
    # ifconfig
![IP_BULMA](DEFENCESPACECTF-2017/Pics/ifconfig.png "IP_BULMA")

Daha sonra Kali’min bulunduğu scope taki IP’leri tarayarak devam ediyorum.

    # netdiscover -i eth0 -r 192.168.56.0/24
![NETDISCOVER](DEFENCESPACECTF-2017/Pics/netdiscover.png "NETDISCOVER")

Ve hedef IP'yi bulduğuma göre nmap atarak devam ediyorum.

    #nmap -A -p- -Pn -sT 192.168.56.20
![NMAP](DEFENCESPACECTF-2017/Pics/nmap.png "NMAP")
...
![WEB_PAGE](DEFENCESPACECTF-2017/Pics/WEB_PAGE.png "WEB_PAGE")
...
![SOURCE_CODE](DEFENCESPACECTF-2017/Pics/SOURCE_CODE.png "SOURCE_CODE")
...
![assets](DEFENCESPACECTF-2017/Pics/assets.png "assets")
...
![Flag3](DEFENCESPACECTF-2017/Pics/flag3.png "Flag3")
...
![Unit990](DEFENCESPACECTF-2017/Pics/Unit990.png "Flag3")
...
![RESİM](DEFENCESPACECTF-2017/Pics/unit990sourcecode.png "Source_code")
...
![Picture](DEFENCESPACECTF-2017/Pics/admin_panel.png "Picture")
...
![admin_panel_source-code](DEFENCESPACECTF-2017/Pics/admin_panel_source-code.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/SSH.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/lastwords.png "Picture")

Şimdi asıl önemli yere, admin paneline geldim. Aynı SQL Injection metoduyla giriyorum.

![Picture](DEFENCESPACECTF-2017/Pics/admin.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/loginNigairforcecloud.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/assets_again "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/Flag7.png "Picture")
...
Yine beni kandırır mı diye bi baktım ve evet 32 karakter var md5 decode:) Decode edince `widgets` çıktısını aldım ve sayfanın solunda widgets diye bir link görüyorum. Hemen basıyorum. İçerde bir ses dosyası bir de resim dosyası var. İkisini de bilgisayarıma çektikten sonra ilk önce resimi gözüme kestirip üzerinde baya bi araştırma yaptıktan sonra içinde hiçbir şey bulamadım :) Ben de ses dosyasına geçtim. Dosyayı açıyorum sürüyor sürüyor... Ama içinde herhangi bir ses yok muhtemelen ses olarak gönderilmiş ama içine bir şeyler gömülmüş. Tabi tamamen tahmin aşamasında şu anda:) Hemen araştırmaya başlıyorum. 
    ...
    # file Alfajet106.wav
![Picture](DEFENCESPACECTF-2017/Pics/file.png "Picture")
Tamam normal bir .wav dosyası olarak görünüyor.

    # strings Alfajet106.wav
![Picture](DEFENCESPACECTF-2017/Pics/strings.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/infonopass.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/info.png "Picture")
İçinde "Topsecret.txt" adında bir dosya var. Bunu gördüm. Passphrase' i de bildiğim için çıkartıyorum ve çıkan dosyayı okuyorum.
    ...
    # cat Topsecret.txt
![Picture](DEFENCESPACECTF-2017/Pics/last.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/sqlmap1.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/sqlmap-dbs.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/sqlmap-tables.png "Picture")
...
![Picture](DEFENCESPACECTF-2017/Pics/sqlmap-son.png "Picture")
